...
const AI_JSON_PROMPT_MD_PATH = "docs/generation/AI_ABC_JSON_WORKFLOW_PROMPT.md";
const AI_JSON_PROMPT_TS_PATH = "src/ts/aiJsonPromptText.ts";
...
const syncBuiltInSamples = () => {
  if (existsSync(toAbs(SAMPLE1_MXL_PATH))) {
    ...
    writeFileSync(toAbs(SAMPLE1_TS_PATH), generated, "utf8");
  }
  ...
  if (existsSync(toAbs(SAMPLE2_MXL_PATH))) {
    ...
    writeFileSync(toAbs(SAMPLE2_TS_PATH), generated, "utf8");
  }
  ...
  if (existsSync(toAbs(SAMPLE3_MXL_PATH))) {
    ...
    writeFileSync(toAbs(SAMPLE3_TS_PATH), generated, "utf8");
  }
  ...
  if (existsSync(toAbs(SAMPLE4_MXL_PATH))) {
    ...
    writeFileSync(toAbs(SAMPLE4_TS_PATH), generated, "utf8");
  }
  ...
  for (const def of definitions) {
    ...
    writeFileSync(toAbs(def.outTs), generated, "utf8");
  }

  if (existsSync(toAbs(AI_JSON_PROMPT_MD_PATH))) {
    const promptText = readText(AI_JSON_PROMPT_MD_PATH).replace(/\r\n/g, "\n");
    const generated = [
      "// AUTO-GENERATED by scripts/build.mjs from docs/generation/AI_ABC_JSON_WORKFLOW_PROMPT.md.",
      `export const aiJsonPromptText = ${JSON.stringify(promptText)};`,
      "",
    ].join("\n");
    writeFileSync(toAbs(AI_JSON_PROMPT_TS_PATH), generated, "utf8");
  }
};
