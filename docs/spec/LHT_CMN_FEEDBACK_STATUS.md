...
| `lht-switch-help` should not depend on app-side `md-switch` availability | Reflected | The adopted answer is fallback-based self-containment rather than internal `md-switch` registration. README now documents this explicitly. See [components.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/js/components.js):1132 and [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):223 |
| README: explicit integration contract section | Reflected | `Integration Contract` was added. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):89 |
| README: fallback policy and parity table | Reflected | `Fallback / Parity Table` was added. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):130 |
| README: clarify `lht-select-help` declarative JSON lifecycle | Reflected | Lifecycle notes now describe declarative detection timing, script consumption, and observer behavior. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):204 |
| README: official dynamic-options pattern for `lht-select-help` | Reflected | `setOptions([...])`, `getValue()`, `setValue()`, and value retention rules are documented and implemented. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):209 and [components.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/js/components.js):520 |
| Add regression tests for both dependency modes | Partially reflected | New component tests exist and cover several fallback cases, but they do not clearly show a full two-mode matrix of Material-loaded vs Material-not-loaded for every critical `lht-*` component. See [components.test.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/components.test.js) |
| Internally register required `md-*` elements instead of relying on fallback-oriented branching | Intentionally not adopted for now | Current implementation continues to branch on `customElements.get(...)` and relies on documented fallback/self-contained behavior instead of internal `md-*` registration. This looks like an intentional design choice, not a missed implementation. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):26 and [components.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/js/components.js):23 |
| Introduce a full explicit two-mode CI matrix for all critical `lht-*` components | Intentionally not adopted for now | Tests were added, but not as a full framework-level Material-loaded vs Material-not-loaded matrix. The current update suggests incremental test coverage was preferred. See [components.test.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/components.test.js) |
| Preserve `hasDeclarativeOptions` pre-capture in `LhtSelectHelp.connectedCallback()` | Reflected | The implementation still captures declarative-options state before hydration. See [components.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/js/components.js):320 |
| Treat `LhtTextFieldHelp` fallback as supported behavior | Reflected | Fallback is documented and tested, not just left as an implicit implementation detail. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):195 and [components.test.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/components.test.js) |
| Preserve `LhtSwitchHelp` fallback DOM structure | Reflected | README and implementation both use `input.md-switch-input + span.md-switch`. See [README.md](/Users/igapyon/Documents/git/mikuscore/lht-cmn/README.md):223 and [components.js](/Users/igapyon/Documents/git/mikuscore/lht-cmn/js/components.js):1182 |
